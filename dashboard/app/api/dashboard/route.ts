...
const initialHallOfFame = [
  ...
  // Actresses - China
  { name: "Li Yu Xiao", type: "actress", status: "GOAT Status", knownFor: ["Historical Drama", "C-Drama Star"], nationality: "China", note: "Rank #2 Chinese Artist", rank: 2, isChampion: false },
  { name: "Tian Xiwei", type: "actress", status: "All-Star", knownFor: ["New Life Begins", "Romance Star"], nationality: "China", note: "Rank #2 Chinese Artist", rank: 2, isChampion: false },
  { name: "Qi Yu Chen", type: "actress", status: "Rising", knownFor: ["Romance", "Contemporary C-Drama"], nationality: "China", note: "Rank #3 Chinese Artist", rank: 3, isChampion: false },
  { name: "Bao Shang En", type: "actress", status: "Rising", knownFor: ["New Generation Talent"], nationality: "China", note: "Rank #3 Chinese Artist", rank: 3, isChampion: false },
  // Actresses - Korea
  { name: "Kang Mi Na", type: "actress", status: "GOAT Status", knownFor: ["Produce 101", "Hotel Del Luna"], nationality: "Korea", note: "Rank #1 Korean Artist (Absolute Favorite)", rank: 1, isChampion: false },
  { name: "Jeong Min Jeong", type: "actress", status: "GOAT Status", knownFor: ["Visual Star", "Rising Talent"], nationality: "Korea", note: "Rank #1 Korean Artist (Absolute Favorite)", rank: 1, isChampion: false },
  { name: "Jay Han (한제이 / 韓提伊)", type: "actress", status: "GOAT Status", knownFor: ["Independent Works", "Cinematic Shines"], nationality: "Korea", note: "Rank #1 Korean Artist (Absolute Favorite)", rank: 1, isChampion: false },
  { name: "Jeon So Young", type: "actress", status: "Rising", knownFor: ["Prestige Drama"], nationality: "Korea", note: "Rank #3 Korean Artist", rank: 3, isChampion: false },
  { name: "Han Hyo-joo", type: "actress", status: "Classic", knownFor: ["Moving", "W", "Happiness"], nationality: "Korea", note: "Rank #3 Korean Artist", rank: 3, isChampion: false },
  { name: "Park Bo-young", type: "actress", status: "Classic", knownFor: ["Strong Woman Do Bong Soon", "Doom at Your Service"], nationality: "Korea", note: "Rank #3 Korean Artist", rank: 3, isChampion: false },
  { name: "Bae Suzy", type: "actress", status: "Classic", knownFor: ["Start-Up", "Anna", "Vagabond"], nationality: "Korea", note: "Rank #3 Korean Artist", rank: 3, isChampion: false },
  { name: "IU", type: "actress", status: "GOAT Status", knownFor: ["My Mister", "Hotel Del Luna", "Broker"], nationality: "Korea", note: "Rank #3 Korean Artist", rank: 3, isChampion: false },
  { name: "Kim Ji-won", type: "actress", status: "GOAT Status", knownFor: ["Queen of Tears", "Fight for My Way", "Lovestruck in the City"], nationality: "Korea", note: "Rank #3 Korean Artist", rank: 3, isChampion: false },
  { name: "Go Youn-jung", type: "actress", status: "Rising", knownFor: ["Alchemy of Souls", "Moving", "Sweet Home"], nationality: "Korea", note: "Rank #3 Korean Artist", rank: 3, isChampion: false },
  { name: "Hong Hwa-yeon", type: "actress", status: "Rising", knownFor: ["New Generation Drama"], nationality: "Korea", note: "Rank #3 Korean Artist", rank: 3, isChampion: false },
  // Actresses - Hollywood
  { name: "Inde Navarrette", type: "actress", status: "GOAT Status", knownFor: ["13 Reasons Why", "Superman & Lois"], nationality: "Hollywood", note: "Rank #3 Hollywood Artist", rank: 3, isChampion: false },
  { name: "Emma Watson", type: "actress", status: "Classic", knownFor: ["Harry Potter Series", "Beauty and the Beast"], nationality: "Hollywood", note: "Rank #3 Hollywood Artist", rank: 3, isChampion: false },
  { name: "Kathryn Newton", type: "actress", status: "All-Star", knownFor: ["Society", "Ant-Man: Quantumania"], nationality: "Hollywood", note: "Rank #3 Hollywood Artist", rank: 3, isChampion: false },
  // Anime
...
const initialSongs = [
  { title: "Stay With Me", artist: "Miki Matsubara", album: "Pocket Park", category: "All-Time Favorites", duration: "5:12", imageUrl: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=300" },
  { title: "Sparkle", artist: "Tatsuro Yamashita", album: "For You", category: "Hype/J-Pop", duration: "4:15", imageUrl: "https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=300" },
  { title: "Some", artist: "BOL4", album: "Red Planet", category: "Chill Beats", duration: "3:01", imageUrl: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=300" },
  { title: "Flower Way", artist: "KIM SEJEONG", album: "I'm", category: "K-Osts", duration: "3:56", imageUrl: "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=300" },
];
  ...
  try {
    ...
    if (!dbProfile) {
      dbProfile = await prisma.profile.create({
        data: {
          ...
          borderStyle: initialProfile.borderStyle,
        },
      });
    }
    ...
    if (dbHOF.length === 0) {
      ...
      for (const item of (initialHallOfFame as any[])) {
        await prisma.hallOfFame.create({ data: item });
      }
    ...
    // 10. Fetch or Seed Songs
    let dbSongs = await prisma.song.findMany({ orderBy: { createdAt: "desc" } });
    if (dbSongs.length === 0) {
      await prisma.song.createMany({ data: initialSongs });

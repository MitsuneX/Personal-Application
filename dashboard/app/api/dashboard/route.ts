  ...
  try {
    ...
    if (isGuestCookie || !user) {
      return NextResponse.json({
        ...
        favoriteCharacters: GUEST_FAVORITE_CHARACTERS,
        dramas: GUEST_DRAMAS,
        hallOfFame: GUEST_HALL_OF_FAME,
        notes: GUEST_NOTES,
        links: GUEST_LINKS,
        gallery: GUEST_GALLERY,
        songs: GUEST_SONGS,
        dramaLog: GUEST_MOVIES,
        savedPrompts: GUEST_SAVED_PROMPTS,
        hobbySkills: GUEST_HOBBY_SKILLS,
